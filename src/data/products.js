...
export const products = [
  {
    ...
    tags: ['soap', 'holder', 'stainless steel', 'wall-mounted', 'silver'],
    isPopular: true,
    isNew: false,
    price: 24.99,
  },
  {
    ...
    availability: 'In Stock',
    tags: ['soap', 'dispenser', 'stainless steel', 'pump', 'silver'],
    isPopular: true,
    isNew: false,
    price: 34.99,
  },
  {
    ...
    availability: 'In Stock',
    tags: ['towel', 'ring', 'stainless steel', 'silver'],
    isPopular: false,
    isNew: true,
    price: 19.99,
  },
  {
    ...
    size: '600 mm',
    availability: 'In Stock',
    tags: ['towel', 'rod', 'double', 'stainless steel', 'silver'],
    isPopular: true,
    isNew: false,
    price: 44.99,
  },
  {
    ...
    size: '600 x 120 mm',
    availability: 'In Stock',
    tags: ['glass', 'shelf', 'storage', 'clear'],
    isPopular: false,
    isNew: true,
    price: 29.99,
  },
  {
    ...
    size: '250 x 250 mm',
    availability: 'In Stock',
    tags: ['corner', 'shelf', 'storage', 'stainless steel', 'silver'],
    isPopular: false,
    isNew: false,
    price: 26.99,
  },
  {
    ...
    size: '75 x 55 mm',
    availability: 'In Stock',
    tags: ['robe', 'hook', 'stainless steel', 'silver'],
    isPopular: true,
    isNew: false,
    price: 14.99,
  },
  {
    ...
    size: '160 x 100 mm',
    availability: 'In Stock',
    tags: ['paper', 'holder', 'toilet', 'stainless steel', 'silver'],
    isPopular: false,
    isNew: true,
    price: 22.99,
  },
  {
    ...
    size: '600 mm',
    availability: 'In Stock',
    tags: ['grab', 'bar', 'safety', 'accessibility', 'silver'],
    isPopular: true,
    isNew: false,
    price: 39.99,
  },
  {
    ...
    size: 'Set of 3',
    availability: 'In Stock',
    tags: ['bathroom', 'set', 'complete', 'stainless steel', 'silver'],
    isPopular: false,
    isNew: true,
    price: 89.99,
  },
  {
    ...
    size: '800 mm',
    availability: 'In Stock',
    tags: ['luxury', 'towel', 'rod', 'gold', 'brass', 'premium'],
    isPopular: true,
    isNew: false,
    price: 129.99,
  },
  {
    ...
    size: '700 x 700 mm',
    availability: 'In Stock',
    tags: ['mirror', 'cabinet', 'storage', 'black', 'premium', 'led'],
    isPopular: false,
    isNew: true,
    price: 249.99,
  },
